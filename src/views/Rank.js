        ...
        {rank.map(user => { number += 1;
            return <div class="h-24 w-full flex flex-row"> 
                <div class="flex item-right w-1/12 text-center">
                    <h1 class="text-3xl text-bold my-auto">{number}</h1>
                </div>
            <div class="flex flex-row w-full my-auto">
                <img class="my-auto w-1/4 h-16" src="https://image.flaticon.com/icons/svg/527/527489.svg"></img>
                <h1 class="my-auto w-2/4 text-2xl text-center">{user.이름}</h1>
